...
INSERT INTO payment(transferred_date, transferred_amount,income_tax, income_before_tax, payment_type, assignment_detail_id, is_paid, is_manually_updated)
VALUES
--on going
('2022-07-15', 4536000, 504000, 5040000, 'CASH', 1, FALSE, FALSE),
('2022-07-15', 9000000, 1000000, 10000000, 'CREDITCARD', 2, FALSE, FALSE),

('2022-07-15', 4536000, 504000, 5040000, 'CASH', 3, FALSE, FALSE),
('2022-07-15', 9000000, 1000000, 10000000, 'CREDITCARD', 4, FALSE, FALSE),

('2022-07-31', 4536000, 504000, 5040000, 'CASH', 5, FALSE, FALSE),
('2022-07-31', 8640000, 960000, 9600000, 'CREDITCARD', 6, FALSE, FALSE),

('2022-07-31', 11340000, 1260000, 12600000, 'CREDITCARD', 7, FALSE, FALSE),
('2022-07-31', 13500000, 1500000, 15000000, 'CREDITCARD', 8, FALSE, FALSE),

('2022-08-31', 6142500, 682500, 6825000, 'CREDITCARD', 9, FALSE, FALSE),
('2022-08-31', 11340000, 1260000, 12600000, 'CREDITCARD', 10, FALSE, FALSE),

('2022-10-15', 6804000, 756000, 7560000, 'CREDITCARD', 11, FALSE, FALSE),
('2022-10-15', 12960000, 1440000, 14400000, 'CREDITCARD', 12, FALSE, FALSE),

('2022-07-31', 3780000, 420000, 4200000, 'CREDITCARD', 13, FALSE, FALSE),
('2022-07-31', 8640000, 960000, 9600000, 'CREDITCARD', 14, FALSE, FALSE),

('2022-08-15', 4788000, 532000, 5320000, 'CREDITCARD', 15, FALSE, FALSE),
('2022-08-15', 7776000, 864000, 8640000, 'CREDITCARD', 16, FALSE, FALSE),

('2022-09-15', 11718000, 1302000, 13020000, 'CREDITCARD', 17, FALSE, FALSE),
('2022-09-15', 12960000, 1440000, 14400000, 'CREDITCARD', 18, FALSE, FALSE),

('2022-09-15', 11718000, 1302000, 13020000, 'CREDITCARD', 19, FALSE, FALSE),
('2022-09-15', 12960000, 1440000, 14400000, 'CREDITCARD', 20, FALSE, FALSE),

('2022-09-15', 6615000, 735000, 7350000, 'CREDITCARD', 21, FALSE, FALSE),
('2022-09-15', 12960000, 1440000, 14400000, 'CREDITCARD', 22, FALSE, FALSE),

-- NEW CLASS

-- finished
('2022-07-31', 7182000, 798000, 7980000, 'CREDITCARD', 23, TRUE, FALSE),
('2022-07-31', 13500000, 1500000, 15000000, 'CREDITCARD', 24, TRUE, FALSE),

('2022-07-31', 4536000, 504000, 5040000, 'CASH', 25, TRUE, FALSE),
('2022-07-31', 7776000, 864000, 8640000, 'CREDITCARD', 26, TRUE, FALSE),

('2022-07-31', 10962000, 1218000, 12180000, 'CREDITCARD', 27, TRUE, FALSE),
('2022-07-31', 12960000, 1440000, 14400000, 'CREDITCARD', 28, TRUE, FALSE);